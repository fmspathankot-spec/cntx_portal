...
export default function OSPFNeighborsCard({ data, isLoading, routerName }) {
  ...
  const neighborCount = data?.neighbor_count || neighbors.length || 0;
        ...
        {!neighbors || neighbors.length === 0 ? (
          ...
          <div className="space-y-3">
            {neighbors.map((neighbor, index) => (
              <div 
                key={neighbor?.neighbor_id || index}
              ...
              >
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="font-medium text-gray-900">
                        {neighbor?.neighbor_id || 'N/A'}
                      </div>
                      <div className="text-sm text-gray-500">
                        {neighbor?.neighbor_address || 'N/A'}
                      </div>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-3 gap-4 text-sm">
                  <div>
                    ...
                    <div className="font-medium text-gray-900">{neighbor?.interface || 'N/A'}</div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="font-medium text-gray-900">{neighbor?.area_id || 'N/A'}</div>
                  </div>
                </div>
              </div>
            ))}
